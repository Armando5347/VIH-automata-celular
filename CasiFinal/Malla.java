...
private void buildMain() {
    ...
    botonEstadisticas.addActionListener(new ActionListener() {
        @Override
        public void actionPerformed(ActionEvent e) {
            densidadGrafica.mostrarGrafico(automata.getcabeceraDensidades()); // Añade esta línea para mostrar el gráfico de densidades
        }
    });
}
...
private void updateAnimation() {
    ...
    // Ajusta el margen dinámicamente según el tamaño de las celdas
    int margin = cellWidth < 3 || cellHeight < 3 ? 0 : 1;
